      ...
      (t.hookAjax = function(t) {
        ...
        function i(n) {
          return function() {
            ...
            if (!t[n] || !t[n].call(this, r, this.xhr))
              return this.xhr[n].apply(this.xhr, r);
          };
        }
        return (
...
function _a() {
  _h(
    "POST",
    window.ysgz.baseUrl + "/sso/auth?teamsunToken=" + getCookie("teamsunToken"),
    function(d) {
      if (d.returnCode == "003") {
    ...
    if (getCookie("teamsunToken")) {
      hookAjax({
        open: function(arg, xhr) {
          ...
          if (arg[1].indexOf("?") > 0) {
            arg[1] += "&teamsunToken=" + getCookie("teamsunToken");
          } else {
            arg[1] += "?teamsunToken=" + getCookie("teamsunToken");
          }
        }
